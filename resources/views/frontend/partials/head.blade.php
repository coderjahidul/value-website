...
@endphp
    ...
    {{--
        Load Tailwind BEFORE Bootstrap.
        CSS cascade rule: later stylesheet wins for equal-specificity rules.
        So Bootstrap always overrides Tailwind on any shared class names.
        Tailwind's preflight (base reset) is disabled via tailwind.config.js.
    --}}
