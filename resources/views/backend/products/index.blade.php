        ...
        <div class="row mb-2 toolbar-sticky">
          <div class="col-md-8">
            <div class="d-flex flex-wrap align-items-center gap-2">
              ...
              @can('product.delete')
                <button class="btn btn-sm btn-danger bulk-delete-btn" id="bulkDeleteBtn" disabled>
...
(function(){
  ...
  $(document).on('click', '#bulkDeleteBtn', function(e){
    ...
    if(!confirm('Are you sure you want to delete ' + product_ids.length + ' selected product(s)? This action cannot be undone.')){
      return;
    }
