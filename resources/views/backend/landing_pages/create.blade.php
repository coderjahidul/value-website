        ...
        <div class="col-lg-12">
            <div class="mb-3">
                ...
                <div id="des1-container">
                    <div class="des1-item mb-2" data-index="0">
                        <div class="input-group">
                            <textarea class="form-control des1-field" name="des1[]" rows="3" placeholder="Enter description"></textarea>
                            <button type="button" class="btn btn-danger remove-des1" style="display:none;">
