...
@section('content')
  ...
  <div class="row">
    <div class="col-12">
      <div class="card">
        <div class="card-body">
          <form method="POST" action="{{ route('admin.landing_pages_two_update', [$item->id]) }}" id="ajax_form">
            @csrf
            @method('PATCH')
            <div class="row">
              <div class="col-lg-6">
              ...
              <div class="col-lg-6" id="product_search" style="display: {{ $single_product ? 'none' : 'block' }};">
                <div class="mb-3">
      ...
      $('.summernote').summernote({
        ...
        callbacks: {
          onImageUpload: function(files) {
            let editor = $(this); // Current editor
            ...
            $.ajax({
              ...
              success: function(resp) {
                if (resp.url) {
                  editor.summernote('insertImage', resp.url); // Insert into #feature
                } else {
